    ...
    <Container>
      ...
      <TopContainer>
          <Router basename="walton-test">
              ...
              <NavLinks><Link to="/Usługi" onClick={() => {window.location.href="walton-test/Usługi"}} style={{ textDecoration: 'none', color:'black' }}>Usługi</Link><Triangle></Triangle></NavLinks>
              <NavLinks><Link to={"/Kalkulator"} onClick={() => {window.location.href="walton-test/Kalkulator"}} style={{ textDecoration: 'none', color:'black' }}>Kalkulator</Link></NavLinks>
              <NavLinks><Link to={"/Realizacje"} onClick={() => {window.location.href="walton-test/Realizacje"}} style={{ textDecoration: 'none', color:'black' }}>Realizacje</Link></NavLinks>
              <NavLinks><Link to={"/Referencje"} onClick={() => {window.location.href="walton-test/Referencje"}} style={{ textDecoration: 'none', color:'black' }}>Referencje</Link></NavLinks>
