    ...
    return(
     <MainContainer>
         <Sides>
             <LeftSide>
                 <SmallLogos />
                 <GreenText>BĄDŹ NA BIERZĄCO</GreenText>
                 <NormalText>Informacje z branży.</NormalText>
                 <Router><Link to="/Aktualności" style={{textDecoration: 'none', width:"288px", height:"48px"}}><AdvisorButton
